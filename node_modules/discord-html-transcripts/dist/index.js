...
var createTranscript = function (channel, opts) { return __awaiter(void 0, void 0, void 0, function () {
    var options, sum_messages, last_id, options_1, messages;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                options_1 = { limit: 100, before: last_id };
                if (!last_id)
                    delete options_1['before'];
            ...
            case 2:
                ...
                if (messages.size != 100 || ((options_1.limit > 0) && sum_messages.length >= options_1.limit))
                    return [3 /*break*/, 3];
                return [3 /*break*/, 1];
            case 3: return [4 /*yield*/, (0, exporthtml_1.default)(sum_messages, channel, options)];
