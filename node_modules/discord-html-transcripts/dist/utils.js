...
exports.charCodeUTF32 = exports.downloadImageToDataURL = void 0;
var axios_1 = require("axios");
function downloadImageToDataURL(url) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(url, {
                        ...
                        var data = Buffer.from(res.data, 'binary').toString('base64');
                        var mime = res.headers['content-type'];
                        return "data:".concat(mime, ";base64,").concat(data);
                    }).catch(function (err) {
...
var charCodeUTF32 = function (char) {
